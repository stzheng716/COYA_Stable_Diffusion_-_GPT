...
function drawBodyHTML() {
    ...
    if (messages.length == 0) {
        ...
        buttonText.setAttribute("id", "text");
        buttonText.addEventListener("click", function (e) {
            handleSubmit(e, textInput.value);
        });
        buttonText.innerHTML = "submit";
        formInput.appendChild(textInput)
        formInput.appendChild(buttonText)

        storyContainer.appendChild(formInput);
